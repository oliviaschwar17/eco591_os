...
# run fastp
fastp -i ~/bioe-591-genomics/course-materials/data/raw_reads/Diglossa_lafresnayii/Diglossa_lafresnayii_219529_R1_001.fastq.gz \
-o ~/bioe-591-genomics/students/liv-schwartz/trimmed_reads/Diglossa_lafresnayii_219529_R1_001_trim.fastqz \
-I ~/bioe-591-genomics/course-materials/data/raw_reads/Diglossa_lafresnayii/Diglossa_lafresnayii_219529_R2_001.fastq.gz \
-O ~/bioe-591-genomics/students/liv-schwartz/trimmed_reads/Diglossa_lafresnayii_219529_R2_001_trim.fastq.gz \
